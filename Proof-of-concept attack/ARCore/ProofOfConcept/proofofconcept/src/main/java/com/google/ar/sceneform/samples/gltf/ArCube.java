...
public class ArCube {
    ...
    public ArCube(String name, Color cubeColor, Context context, ArFragment arFragment, AnchorNode parent,
                  LabelPosition labelPosition, TextView infoView, Queue<Integer> clicked) {
        this.name = name;
        this.numTaps = 0;
...
//                        infoView.setText(updateStateText);
                        this.clicked.add(Integer.parseInt(this.name));
                    });
     ...
     */
    public ArCube(String name, Color cubeColor, Context context, ArFragment arFragment, AnchorNode parent,
                  LabelPosition labelPosition, TextView infoView, Queue<Integer> clicked, Vector3 offset) {
        this.name = name;
        this.numTaps = 0;
        this.parentNode = parent;
        this.labelView = null;
...
//                        infoView.setText(updateStateText);
    ...
    private Vector3 getLabelPosition(Vector3 cubePosition, LabelPosition labelPosition) {
        if (labelPosition == LabelPosition.LEFT) {
            return new Vector3(cubePosition.x - 0.1f, cubePosition.y - 0.05f, cubePosition.z);
