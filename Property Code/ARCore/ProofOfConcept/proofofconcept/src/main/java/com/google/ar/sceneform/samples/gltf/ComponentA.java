...
public class ComponentA implements com.google.ar.sceneform.samples.gltf.ARComponent {
    ...
    @Override
    public void launch() {
        this.keypad = new ArKeypad("Keypad", new Color(255, 0, 0), this.context, this.arFragment, this.anchorNode,
...
//        cube1.removeCube();
//        cube1 = new ArCube("Cube 1", new Color(255, 0, 0), this.context, this.arFragment, this.anchorNode,
//                ArCube.LabelPosition.LEFT,
//                Globals.CLICK_INFO_LABELS.get(0));
    }
}
