...
// {
//     [SerializeField]
//     // To do: add multiple prefab
//     public GameObject anchorPrefab, secondAnchorPrefab;
...
//         GameObject anchorObject2 = Instantiate(secondAnchorPrefab);
...
//         resolvedAnchors.Add(anchorHandle, anchorObject2);
...
//             Logger.Instance.LogInfo($"Spatial anchor position: {OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch)}");
//             // Logger.Instance.LogInfo($"Pose in space: {controllerPose.ToPosef()}");
