...
export class ComponentA {
     ...
     */
    launch() {
        let cube2 = makeCube(this.scene, "2", this.reticlePosition.x + 2 * this.cubeSize, this.reticlePosition.y, this.reticlePosition.z, 0xff0000, Location.Above, 0);
    ...
    next(experimentNumber) {
        ...
        if (experimentNumber === 1) {
            cube1 = makeCube(this.scene, "1", this.reticlePosition.x, this.reticlePosition.y, this.reticlePosition.z, 0xff0000, Location.Left, 0);
