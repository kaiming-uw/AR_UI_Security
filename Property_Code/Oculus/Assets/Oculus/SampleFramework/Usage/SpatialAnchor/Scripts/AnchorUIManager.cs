...
public class AnchorUIManager : MonoBehaviour
{
    ...
    private void PlaceAnchor()
    {
        ...
        if (expNum == 0){
            ...
            Instantiate(_FirstanchorPrefab, _secondAnchorTransform.position, _secondAnchorTransform.rotation);
            Instantiate(_FirstanchorPrefab, _secondAnchorTransform.position + _raycastOrigin.TransformDirection(Vector3.right) * 0.5f, _secondAnchorTransform.rotation);
        }
