...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Globals.CLICK_INFO_LABELS.add(findViewById(R.id.cube3_1_info));
        Globals.CLICK_INFO_LABELS.add(findViewById(R.id.cube3_2_info));
        Globals.CLICK_INFO_LABELS.add(findViewById(R.id.cube3_3_info));
        Globals.CLICK_INFO_LABELS.add(findViewById(R.id.cube3_4_info));
        ...
        if (this.anchor == null) {
            ...
            mNextButton.setOnClickListener((view -> {
                ...
                else if(this.experimentNum == 2 && this.anchor != null)
                {
                    ...
                    mMessageText.setText("Verify you can no longer see cube 1 and click experiment: " + (this.experimentNum - 2 + 1));
                    mNextButton.setText("Experiment: " + (this.experimentNum - 2 + 1));
                    mMessageView.setVisibility(View.VISIBLE);

                }
                else if (this.experimentNum < 7)
                {
                    this.componentA.next(this.experimentNum - 2);
                    this.componentB.next(this.experimentNum - 2);
                    if(this.experimentNum == 6)
                    {
                        mMessageText.setText("Verify whether you can interact with cube 1 and whether you can see the invisible cube. Then refresh experiment.");
                        mNextButton.setText("Experiments Finished");
                    } else
                    {
                        mMessageText.setText("Verify whether you can interact with cube 1 and whether you can see the invisible cube. Then click experiment: " + (this.experimentNum - 2 + 1));
                        mNextButton.setText("Experiment: " + (this.experimentNum - 2 + 1));
                    }
                    mMessageView.setVisibility(View.VISIBLE);
                }
